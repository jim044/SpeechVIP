					...
					if (wordInfo.confidence > 0.9)
					{
				        ...
				        if( j % 3 === 0)
				        {
				        	...
				        	console.log("sentence " + sentence)
				        		...
				        		await cutVideo(sentence, nameOfFile, folderName, fileNameVideo, debutDuDecoupage, finDuDecoupage, numberCut).then(function(leResultat) {
					        	// console.log("i : " + i)
...
var cutVideo = async function(sentenceTranscrib, nameOfFile, folderName, videoPath, startTime, endTime, numberToCut)
{
