...
module.exports = function(app) {
	...
	var cutVideo = function(wordTranscrib, nameOfFile, folderName, videoPath, startTime, endTime, numberToCut)
	{
		return new Promise( function(resolve, reject)
		{
			...
			console.log(folderName + nameOfFile + '_Cut_' + numberToCutMoisUn + '.mp4')
			console.log(parseFloat(endTime) - parseFloat(startTime));
			...
			.on('end', function(err) {   
				if(!err)
				{
					...
					var sql2 = 'INSERT INTO video_cut (id_video, nom, mot, duree) VALUES (' + idVideo + ',"' + nomFichierCouper + '","' + wordTranscrib + '",' + duration + ')';
